...
from datalab.src.importers.es_impoters import es_insert
...
class MyTestCase(unittest.TestCase):
    def test_es_insert(self):
        ...
        (ok, result) = es_insert(es_object=es, data=data)
        time.sleep(UPDATETIME)
        self.assertEqual(ok, True)
        self.assertTrue(_es_is_data(es, index="opslog", doc_type="opslog", id="afa98a536c513056ac60368c222bda4c"))
        self.assertTrue(_es_is_data(es, index="opslog", doc_type="opslog", id="9bde7bc7e466ab8db180492c96020d5b"))
        self.assertTrue(_es_is_data(es, index="vltlog", doc_type="fpar", id="afa98a536c513056689fa883f14f831a"))
        self.assertTrue(_es_is_data(es, index="vltlog", doc_type="log", id="afa98a536c513056ae1269ccf4fd8807"))
        es.delete(index="opslog", doc_type="opslog", id="afa98a536c513056ac60368c222bda4c")
        es.delete(index="opslog", doc_type="opslog", id="9bde7bc7e466ab8db180492c96020d5b")
        es.delete(index="vltlog", doc_type="fpar", id="afa98a536c513056689fa883f14f831a")
        es.delete(index="vltlog", doc_type="log", id="afa98a536c513056ae1269ccf4fd8807")

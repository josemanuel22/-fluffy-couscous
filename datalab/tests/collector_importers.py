...
class MyTestCase(unittest.TestCase):
    def test_collector_datalab_period(self):
        ...
        period = (past, present)
        collector_datalab_period(db_connection, period, kairos_server, es_object)
    ...
    def test_collector_datalab_present(self):
        ...
        collector_datalab_present(db_connection, kairos_server, es_object, delay=delay)
        time.sleep(UPDATETIME)
        self.assertGreater(_es_is_data(es_object, 'vltlog', 'fpar', past, present), 0)
    ...
    def test_collector_datalab_backwards(self):
        ...
        collector_datalab_backwards(db_connection, kairos_server, es_object, start=start)
        time.sleep(UPDATETIME)
    ...
    def test_datalab_period_2(self):
        ...
        period=(past,start)
        collector_datalab_period_2(db_connection, kairos_server, es_object, period)
        time.sleep(UPDATETIME)
        self.assertGreater(_es_is_data(es_object, 'vltlog', 'fpar', past, start), 0)
